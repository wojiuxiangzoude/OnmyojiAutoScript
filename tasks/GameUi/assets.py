...
class GameUiAssets: 
	...
	# description 
	I_CHECK_EXPLORATION = RuleImage(roi_front=(1140,103,45,51), roi_back=(1140,103,45,51), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_exploration.png")
	# 探索前往觉醒 
